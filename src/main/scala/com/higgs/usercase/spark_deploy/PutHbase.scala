//package com.higgs.usercase.spark_deploy
//
//import io.vertx.core.json.JsonObject
//import org.apache.hadoop.com.higgs.hbase.{HBaseConfiguration, TableName}
//import org.apache.hadoop.com.higgs.hbase.client.{ConnectionFactory, Put}
//import org.apache.hadoop.com.higgs.hbase.io.ImmutableBytesWritable
//import org.apache.hadoop.com.higgs.hbase.mapred.TableOutputFormat
...
//    System.setProperty("java.security.krb5.conf", "/Users/devops/Documents/disti_setting/com.higgs.hbase-conf/krb5.conf")
//    // System.setProperty("java.security.krb5.conf", "/data/home/idmg/shell/conf/krb5.conf")
//    val sc = new SparkContext(new SparkConf().setMaster("local").setAppName("com.higgs.hbase"))
//    val rdd = sc.textFile(src).foreachPartition { x =>
//      val conf = HBaseConfiguration.create()
//      conf.set("hadoop.security.authentication", "Kerberos")
//      conf.set(MRJobConfig.TASK_TIMEOUT, "6000000")
//      conf.setInt("com.higgs.hbase.rpc.timeout", 900000)
//      conf.setInt("com.higgs.hbase.client.operation.timeout", 900000)
//      conf.setInt("com.higgs.hbase.client.scanner.timeout.period", 900000)
//      // conf.addResource("/data/home/idmg/shell/conf/core-site.xml")
//      // conf.addResource("/data/home/idmg/shell/conf/com.higgs.hbase-site.xml")
//      // conf.addResource("/data/home/idmg/shell/conf/hdfs-site.xml")
//      conf.addResource("/Users/devops/Documents/disti_setting/com.higgs.hbase-conf/core-site.xml")
//      conf.addResource("/Users/devops/Documents/disti_setting/com.higgs.hbase-conf/com.higgs.hbase-site.xml")
//      conf.addResource("/Users/devops/Documents/disti_setting/com.higgs.hbase-conf/hdfs-site.xml")
...
//        "/Users/devops/Documents/disti_setting/com.higgs.hbase-conf/krb5.keytab")
//      conf.set("com.higgs.hbase.zookeeper.quorum", "172.20.0.152,172.20.0.102,172.20.0.151")
